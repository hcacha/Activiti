...
public class GoogleTokenServices extends RemoteTokenServices {
	...
	private static final Logger log = LoggerFactory.getLogger(GoogleTokenServices.class);
    ...
    public GoogleTokenServices(String userInfoEndpointUrl, String clientId) {
    	this.checkTokenEndpointUrl = userInfoEndpointUrl;
